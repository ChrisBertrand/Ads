...
namespace AdvertisingApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc()
                .AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<AdvertValidator>())
            .SetCompatibilityVersion(CompatibilityVersion.Version_2_2);

            services.AddDbContext<AdvertContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("AdvertContext")));
